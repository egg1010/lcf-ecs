...
template <typename T>
T& class_pool<T>::at(size_t index) noexcept {
...
template <typename T>
const T& class_pool<T>::at(size_t index) const noexcept {
	if (index >= index_) [[unlikely]] {
		std::terminate();
	}
	return data_ptr_[index];
...
// --- for_each / for_each_sparse ---

template <typename T>
template <typename F>
void class_pool<T>::for_each(F&& f) noexcept
{
	if (is_dense_) [[likely]]
	{
...
template <typename T>
template <typename F>
void class_pool<T>::for_each(F&& f) const noexcept
{
	if (is_dense_) [[likely]]
	{
...
template <typename T>
template <typename F>
void class_pool<T>::for_each_sparse(F&& f) noexcept
{
...
template <typename T>
template <typename F>
void class_pool<T>::for_each_sparse(F&& f) const noexcept
{
