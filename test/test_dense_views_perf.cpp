// test_dense_views_perf.cpp - dense<T> 视图接口性能测试 (A-K 分类), 使用 time.hpp
#include "perf_common.hpp"
#include "include/part/dense.hpp"

using namespace std;

// === 测试组件 (POD4/POD12/POD32 来自 perf_common.hpp, 此处仅补 POD128 与比较运算符) ===
struct POD128 { float a[32]; };

// 为 perf_common.hpp 的 POD4/POD32 补充比较运算符 (非成员, ADL 可见)
