...
int main()
{
    ...
    print_section(15, "starts_with / ends_with");
    {
        utf8pp s("Hello世界");
    ...
    print_section(20, "to_lower / to_upper");
    {
    ...
    print_section(24, "构造/assign/append 范围重载");
    {
    ...
    // === 25. data()/c_str() 空串返回 "" ===
    print_section(25, "data()/c_str() 空串安全");
    {
        utf8pp empty;
    ...
    print_section(26, "max_size / reserve_exact / increase_capacity");
    {
        utf8pp s;
    ...
    print_section(27, "resize_cp / pop_back / append_cp / assign_cp / 构造(n,cp)");
    {
    ...
    print_section(29, "find_first_of / find_last_of / find_first_not_of / find_last_not_of");
    {
        utf8pp s("Hello世界World");
    ...
    // === 31. reverse_iterator ===
    print_section(31, "reverse_iterator");
    {
        utf8pp s("abc");
    ...
    // === 33. operator<</>> 流操作符 ===
    print_section(33, "operator<</>> 流操作符");
    {
        utf8pp s("Hello世界");
    ...
    // === 34. operator<=> 三路比较 ===
    print_section(34, "operator<=> 三路比较");
    {
        utf8pp a("abc");
        utf8pp b("abd");
        utf8pp c("abc");
    ...
    print_section(35, "迭代器版 insert/erase");
    {
        utf8pp s("acd");
        auto it = s.begin();
        ++it;
    ...
    print_section(36, "std::swap 非成员 + std::hash");
    {
        utf8pp a("Hello");
        utf8pp b("World");
        swap(a, b);
    ...
    {
        int h = _heapchk();
        print_item("section 36 后堆检查", h == _HEAPOK);
    }
#endif

    // === 37. find/rfind 的 const char*/string_view 重载 ===
    print_section(37, "find/rfind const char*/string_view 重载");
    {
        utf8pp s("Hello世界World");
    ...
    print_section(38, "find_*_of const char*/string_view 重载");
    {
        utf8pp s("Hello世界World");
    ...
    print_section(40, "replace 字符串重载 + compare 子串");
    {
        utf8pp s("Hello世界World");
        s.replace(0, 5, "Hi");
    ...
    print_section(41, "operator==/string_view + <=>/string_view");
    {
        utf8pp s("Hello");
    ...
    print_section(42, "SSO 边界测试");
    {
        ...
        swap(a, b);
        // 计算 b 的实际长度 (53 字节), 用动态判断
        print_item("swap SSO满↔heap a (a 拿到 b)", a.size() == 53 && !a.is_sso());
        print_item("swap SSO满↔heap b", b.size() == 22 && b.is_sso());
    }

    // === 43. 数字 → utf8pp (to_utf8pp) ===
    print_section(43, "数字 → utf8pp");
    {
    ...
    print_section(44, "字符串 → 数字 (to_* 系列)");
    {
        utf8pp s("42");
    ...
    print_section(46, "is_integer / is_number / is_float");
    {
    ...
    print_section(47, "reserve_cp / cp_capacity");
    {
        utf8pp s;
    ...
    print_section(48, "data() 非 const + rebuild");
    {
        utf8pp s("hello");
        char* p = s.data();
    ...
    print_section(49, "pad_left / pad_right / center");
    {
        utf8pp s("Hi");
        s.pad_left(5);
    ...
    // === 51. split_view 零拷贝分割 ===
    print_section(51, "split_view 零拷贝分割");
    {
        utf8pp s("a,b,c");
    ...
    // === 52. utf8_view 集成 (view() / u8view() 互操作) ===
    print_section(52, "utf8_view 集成互操作");
    {
        utf8pp s("Hello世界");
    ...
    // === 53. compare 双区间 + replace 迭代器版 ===
    print_section(53, "compare 双区间 + replace 迭代器版");
    {
    ...
    // === 54. 三参 find/find_*_of (s, pos, n) ===
    print_section(54, "三参 find/find_*_of (s, pos, n)");
    {
        utf8pp s("HelloWorld");
    ...
    // === 55. initializer_list 与迭代器范围构造 ===
    print_section(55, "initializer_list 与迭代器范围构造");
    {
    ...
    print_section(57, "字节迭代器");
    {
        ...
        std::vector<char> v;
        for (char c : std::string_view("Hi")) v.push_back(c);
        // 反向字节迭代
        utf8pp s2("abc");
        std::string rev;
        for (auto it = s2.rbyte_begin(); it != s2.rbyte_end(); --it) rev.push_back(*it);
    ...
    // === 60. 大小写转换 (Latin-1 扩展) ===
    print_section(60, "大小写转换 (含 Latin-1)");
    {
        utf8pp s("Hello World");
        s.to_lower();
    ...
    // === 61. trim 谓词版/字符集版 ===
    print_section(61, "trim 谓词版/字符集版");
    {
        utf8pp s("  Hello  ");
        s.trim();
    ...
    // === 62. 数字转换补全 (long double + std 风格别名) ===
    print_section(62, "数字转换补全");
    {
        ...
        utf8pp hex("FF");
        print_item("stoul(16) == 255", hex.stoul(nullptr, 16) == 255);
    ...
    // === 66. 与 std::string/u8string/u32string 互操作 ===
    print_section(66, "与 std 互操作");
    {
        utf8pp s("Hello");
    ...
    // === 68. std::erase / erase_if 自由函数 ===
    print_section(68, "std::erase / erase_if");
    {
        utf8pp s("Hello World");
    ...
    // === 70. 新增接口: _utf8 字面量 / 对称比较 / std::swap ===
    print_section(70, "_utf8 字面量 / 对称比较 / std::swap");
    {
        // _utf8 字面量
    ...
    // === 71. insert 返回引用链式 + 新重载 ===
    print_section(71, "insert 链式 + 新重载");
    {
        utf8pp s("Hello");
        s.insert(0, ">>").insert(0, "==");
    ...
    // === 73. replace initializer_list ===
    print_section(73, "replace initializer_list");
    {
        utf8pp s("Hello World");
    ...
    // === 74. 字节/字形簇 const 迭代器别名 ===
    print_section(74, "const 迭代器别名");
    {
        utf8pp s("ABC");
